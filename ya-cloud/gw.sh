...
yc compute instance create \
 --name gw --hostname gw.sb.stumasov.ru \
 --zone=ru-central1-d \
 ...
 --network-interface subnet-name=private-subnet,ipv4-address=172.16.4.11,dns-record-spec=\{name=gw.sb.stumasov.ru.,dns-zone-id=dnsem7bu52eup0ufq8jh,ttl=600\} \
